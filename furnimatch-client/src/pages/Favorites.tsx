...
const Favorites = () => {
  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div className="rounded-2xl bg-gradient-to-r from-rose-50 to-amber-50 border border-rose-100 p-6 sm:p-8 mb-8 flex flex-col sm:flex-row justify-between gap-5"><div><p className="text-sm font-semibold text-rose-600 uppercase tracking-wider">Bộ sưu tập cá nhân</p><h1 className="text-3xl font-bold text-gray-900 mt-1">Sản phẩm yêu thích</h1><p className="text-gray-600 mt-2">Lưu mẫu, tìm nhanh và đưa các lựa chọn tốt nhất vào bảng so sánh.</p></div><div className="flex gap-3 self-start"><Link to="/inspiration" className="rounded-lg bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm">Bảng cảm hứng</Link><Link to="/compare" className="rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white">So sánh ({comparisonIds.length})</Link></div></div>
